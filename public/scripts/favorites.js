...
window.onload = function displayWatchlist() {
  ...
  if (toWatchTvShows == 0) {
    // SHOW A MESSAGE IF THERE ARE NO MOVIES IN THE LIST.
    tvShowsOutput.innerHTML += `<p class="infoText"> There are no favorite tv shows. Go watch some. <a href="#" onclick="openRecommendTvShowsBox()"> Here are some recommendations !</a> </p>`;
  }
};
// Recommend movies
